...
class FakeCpkReadServiceImpl @Activate constructor(
//    @TempDir
//    testDirectory: Path,
...
//    properties: Map<String, Any?>
    ...
    private val testBundle = bundleContext.bundle.location.let(bundleContext::getBundle)
        //(properties[CpiLoader.TEST_BUNDLE_KEY] as? String)?.let(bundleContext::getBundle)
