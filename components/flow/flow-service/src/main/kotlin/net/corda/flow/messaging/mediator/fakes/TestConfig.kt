...
data class TestConfig(
    ...
    private val commitTimeMs: Long = 0,
    private val resetOffsetTimeMs: Long = 0,
    private val sendTimeMs: Long = 0,
    private val rpcSendTimeMs: Long = 0,
) {
    fun toSmartConfigs(): Map<String, SmartConfig> {
        val flowConfig = SmartConfigImpl.empty()
            ...
            .withValue(FlowConfig.PROCESSING_FLOW_CHECKPOINT_CLEANUP_TIME, fromAnyRef(processingFlowCleanupTime))
            .withValue(FlowConfig.PROCESSING_FLOW_MAPPER_CLEANUP_TIME, fromAnyRef(processingFlowCleanupTime))
