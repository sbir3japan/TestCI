...
data class EvmWaitForTransactionExternalEventFactoryParams(
    val options: EvmOptions,
    val hash: String,
)

@Component(service = [ExternalEventFactory::class])
class EvmWaitForTransactionExternalEventFactory
    : ExternalEventFactory<EvmWaitForTransactionExternalEventFactoryParams, EvmResponse, TransactionReceipt> {
    ...
    override fun createExternalEvent(
        ...
        parameters: EvmWaitForTransactionExternalEventFactoryParams
    ): ExternalEventRecord {
        val transactionReceipt = WaitForTransaction.newBuilder()
