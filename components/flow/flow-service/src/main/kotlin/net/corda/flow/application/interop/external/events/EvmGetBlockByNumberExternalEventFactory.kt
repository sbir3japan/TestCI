...
data class EvmGetBlockByNumberParams(
...
class EvmGetBlockByNumberExternalEventFactory
    : ExternalEventFactory<EvmGetBlockByNumberParams, EvmResponse, Block> {
    ...
    override fun createExternalEvent(
        ...
        parameters: EvmGetBlockByNumberParams
    ): ExternalEventRecord {
        val block = GetBlockByNumber.newBuilder()
