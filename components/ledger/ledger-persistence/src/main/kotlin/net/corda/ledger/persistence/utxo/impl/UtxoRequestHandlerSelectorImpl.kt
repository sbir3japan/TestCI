...
import net.corda.ledger.persistence.utxo.impl.request.handlers.UtxoFetchFilteredTransactionsRequestHandler
...
class UtxoRequestHandlerSelectorImpl @Activate constructor(
    ...
    override fun selectHandler(sandbox: SandboxGroupContext, request: LedgerPersistenceRequest): RequestHandler {
        ...
        return when (val req = request.request) {
            ...
            is FetchFilteredTransactions -> {
                UtxoFetchFilteredTransactionsRequestHandler(
                    req,
                    externalEventContext,
                    persistenceService,
                    outputRecordFactory
