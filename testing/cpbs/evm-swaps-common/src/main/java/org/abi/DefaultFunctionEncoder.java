...
import org.abi.FunctionEncoder;
...
public class DefaultFunctionEncoder extends FunctionEncoder {
    ...
    protected String encodePackedParameters(List<Type> parameters) {
        ...
        for (Type parameter : parameters) {
            result.append(org.abi.TypeEncoder.encodePacked(parameter));
        }
    ...
    private static String encodeParameters(
        ...
        for (Type parameter : parameters) {
            final String encodedValue = org.abi.TypeEncoder.encode(parameter);

            if (org.abi.TypeEncoder.isDynamic(parameter)) {
