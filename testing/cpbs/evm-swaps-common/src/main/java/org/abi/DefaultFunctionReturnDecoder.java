...
import org.abi.FunctionReturnDecoder;
import org.abi.TypeDecoder;
import org.abi.TypeReference;
import org.abi.datatypes.*;
import org.abi.datatypes.generated.Bytes32;
import org.utils.Numeric;
import org.utils.Strings;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static org.abi.TypeDecoder.MAX_BYTE_LENGTH_FOR_HEX_STRING;
import static org.abi.TypeDecoder.isDynamic;
import static org.abi.Utils.getParameterizedTypeFromArray;
import static org.abi.Utils.staticStructNestedPublicFieldsFlatList;
...
public class DefaultFunctionReturnDecoder extends FunctionReturnDecoder {
    ...
    public List<Type> decodeFunctionResult(
            String rawInput, List<org.abi.TypeReference<Type>> outputParameters) {
    ...
    public <T extends Type> Type decodeEventParameter(
            String rawInput, org.abi.TypeReference<T> typeReference) {
    ...
    private static List<Type> build(String input, List<org.abi.TypeReference<Type>> outputParameters) {
        List<Type> results = new ArrayList<>(outputParameters.size());

        int offset = 0;
        for (org.abi.TypeReference<?> typeReference : outputParameters) {
            try {
                ...
                } else if (typeReference instanceof org.abi.TypeReference.StaticArrayTypeReference) {
                    int length = ((org.abi.TypeReference.StaticArrayTypeReference) typeReference).getSize();
                    result =
    ...
    public static <T extends Type> int getDataOffset(
            String input, int offset, org.abi.TypeReference<?> typeReference)
