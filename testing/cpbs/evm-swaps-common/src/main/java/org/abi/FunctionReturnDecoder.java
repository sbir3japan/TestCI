...
import org.abi.DefaultFunctionReturnDecoder;
...
import org.abi.spi.FunctionReturnDecoderProvider;
 ...
 *
 * <p>Delegates to {@link org.abi.DefaultFunctionReturnDecoder} unless a {@link
 * FunctionReturnDecoderProvider} SPI is found, in which case the first implementation found will be
 * used.
 *
 * @see org.abi.DefaultFunctionReturnDecoder
...
public abstract class FunctionReturnDecoder {
     ...
     * @param outputParameters list of return types as {@link org.abi.TypeReference}
     * @return {@link List} of values returned by function, {@link Collections#emptyList()} if
     *     invalid response
     */
    public static List<Type> decode(String rawInput, List<org.abi.TypeReference<Type>> outputParameters) {
    ...
    public static byte[] decodeDynamicBytes(String rawInput) {
        List outputParameters = new ArrayList<org.abi.TypeReference<Type>>();
        outputParameters.add(new org.abi.TypeReference<DynamicBytes>() {});
    ...
    public static String decodeAddress(String rawInput) {
        List outputParameters = new ArrayList<org.abi.TypeReference<Type>>();
        outputParameters.add(new org.abi.TypeReference<Address>() {});
