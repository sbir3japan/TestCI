...
import org.abi.datatypes.Bool;
import org.abi.datatypes.DynamicBytes;
import org.abi.datatypes.Type;
import org.abi.datatypes.Uint;
import org.abi.datatypes.Utf8String;
import org.abi.datatypes.generated.*;
import org.abi.datatypes.primitive.Byte;
import org.abi.datatypes.primitive.Double;
import org.abi.datatypes.primitive.Float;
import org.abi.datatypes.primitive.Int;
import org.abi.datatypes.primitive.Long;
import org.abi.datatypes.primitive.Short;
import org.abi.datatypes.primitive.*;
...
public final class AbiTypes {
     ...
     */
    public static Class<? extends org.abi.datatypes.Type> getType(String type) {
    ...
    public static Class<? extends org.abi.datatypes.Type> getType(String type, boolean primitives) {
        switch (type) {
            case "address":
            ...
            case "boolean":
                return Bool.class;
            case "string":
                return org.abi.datatypes.Utf8String.class;
            case "bytes":
                return org.abi.datatypes.DynamicBytes.class;
            case "byte":
                return Byte.class;
            case "char":
                return Char.class;
            ...
            case "uint":
                return Uint.class;
            case "int":
                return primitives ? Int.class : org.abi.datatypes.Int.class;
            case "long":
                return Long.class;
            case "short":
                return Short.class;
            ...
            default:
                {
                    try {
                        return (Class<? extends org.abi.datatypes.Type>) Class.forName(type);
