...
import org.abi.datatypes.StaticArray;
 ...
 * Typed {@link org.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.abi.datatypes.Type>
    ...
    public static <T extends org.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends org.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends org.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends org.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends org.abi.datatypes.Type> baseClass =
        ...
        while (lastReadStringPosition < len) {
            ...
            if (arraySize == null || arraySize.equals("")) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "org.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
