...
class Create(
    ...
    private val workersForProcessor = mapOf(
        ...
        "flow_db" to listOf("flow",
            ...
            "flow_ledger",
            "combined"),
        "flow_uniqueness" to listOf("flow",
            "flow_start",
            "flow_session",
            "flow_crypto",
            "flow_db",
            ...
            "flow_ledger",
            "combined"),
        "flow_verification" to listOf("flow",
            "flow_start",
            "flow_session",
            "flow_crypto",
            "flow_db",
